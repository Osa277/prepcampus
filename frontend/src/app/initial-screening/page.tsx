    ...
    <main className="min-h-screen flex">
      ...
      <aside className="w-72 bg-blue-600 text-white flex flex-col p-6">
        ...
        <nav className="flex-1 space-y-1 mb-6">
          ...
          <a className="flex items-center gap-2 py-2 px-4 rounded bg-blue-700">
          ...
          <div className="flex-1">
            <div className="mb-4">
              ...
              <p className="mt-2 text-gray-800">
                Tell us about yourself and give an overview of your educational background and key qualifications?
              </p>
            </div>
            <div className="bg-blue-50 p-4 rounded mb-4 text-sm text-gray-700">
              <span className="font-semibold">💡 Tip:</span> Be clear, maintain eye contact, use good lighting, and give specific answers. Experience unlocks badges for great answers!
            </div>
